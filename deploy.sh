...
echo "Building the Flutter web app with base href /Fidgit/"
flutter build web --release --base-href="/Fidgit/" #change '/myappRepo/' to the name of the github repo of your project
...
echo "Deployment complete! Visit: https://EGrey173.github.io/Fidgit/" #change to your username in the link